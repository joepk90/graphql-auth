	...
	return graphql.NewObject(graphql.ObjectConfig{
		...
		Fields: graphql.Fields{
			"is_authorized_to_create_post": &graphql.Field{
				...
				Name:        "is_authorized_to_create_post",
				Description: "Check if user has permissions to create a post",
				Resolve:     s.IsAuthorizedToCreatePost,
			},
			"is_authorized_to_read_post": &graphql.Field{
				Name:        "is_authorized_to_read_post",
				Type:        AuthorizationResponseObject,
				Description: "Check if user has permissions to read a post",
				Resolve:     s.IsAuthorizedToReadPost,
				Args:        getResourceOwnerIdArgs(),
			},
			"is_authorized_to_update_post": &graphql.Field{
				Type:        AuthorizationResponseObject,
				Name:        "is_authorized_to_update_post",
				Description: "Check if user has permissions to update a post",
				Resolve:     s.IsAuthorizedToUpdatePost,
				Args:        getResourceOwnerIdArgs(),
			},
			"is_authorized_to_delete_post": &graphql.Field{
				Type:        AuthorizationResponseObject,
				Name:        "is_authorized_to_delete_post",
				Description: "Check if user has permissions to delete a post",
